...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("expires_at", sa.String(length=32), nullable=False),
        sa.Column("created_at", sa.String(length=32), nullable=False),
        sa.Column("last_used_at", sa.String(length=32), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("followup_due_at", sa.String(length=32), nullable=False),
        sa.Column("initiator_answered_at", sa.String(length=32), nullable=True),
        sa.Column("author_answered_at", sa.String(length=32), nullable=True),
        sa.Column("created_at", sa.String(length=32), nullable=False),
        sa.Column("updated_at", sa.String(length=32), nullable=False),
        sa.CheckConstraint(
